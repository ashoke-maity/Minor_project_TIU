...
const FetchAnnouncementByUserRouter = require('./routes/FetchAnnouncementByUserRoutes');
...
app.use(process.env.USER_ROUTE, FetchAnnouncementByUserRouter); // user can see announcements
