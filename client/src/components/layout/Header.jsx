  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white border-b shadow-sm">
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center">
        {/* Logo */}
        <Link to="/" className="text-2xl font-bold flex items-center gap-2 text-gray-800">
        ...
        <div className="flex items-center gap-6 text-gray-700 text-sm font-medium">
          ...
          <button className="flex items-center gap-1 hover:text-teal-600" title="Notifications">
            <Bell size={20} />
            <span>Notification</span>
          </button>

          <button className="flex items-center gap-1 hover:text-teal-600" title="Jobs">
            <Plus size={20} />
            <span>Jobs</span>
          </button>

          <button className="flex items-center gap-1 hover:text-teal-600" title="My Network">
            <Users size={20} />
