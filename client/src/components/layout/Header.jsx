  ...
  return (
    <header className="sticky top-0 z-50 w-full backdrop-blur-md dark bg-primary-foreground border text-primary-200 md:px-4">
      <div className="container flex h-16 items-center justify-between ">
        <div className="flex items-center gap-2 ">
          <a href="#home">
            <img
              ...
              className="h-20 w-20 invert cursor-pointer"
            />
          </a>
          <span className="text-xl font-bold">
            <a href="#home">AlumniConnect</a>
          </span>
        </div>
        {/* Desktop Navigation */}
        ...
        {/* Mobile Menu Button */}
        <button
          className="md:hidden p-2 cursor-pointer  hover:shadow-primary-200 hover:shadow-lg"
        ...
        >
          <img src="/logout.svg" alt="logout" className="size-6" />
        </button>
