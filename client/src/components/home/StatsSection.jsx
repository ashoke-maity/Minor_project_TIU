...
function StatsSection() {
  return (
    <section id="community" className="w-full flex flex-col items-center h-full text-primary-foreground py-16 bg-primary-foreground ">
      <div className="container ">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center px-4 md:px-12 lg:px-24 py-16 flex-col w-full">
          <div>
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-4 text-primary-200">Join Our Growing Community</h2>
