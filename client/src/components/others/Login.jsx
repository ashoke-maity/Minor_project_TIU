...
function Login() {
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_USER_API_URL}/user/google-login`,
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center">
                    <button
                      ...
                      className="group relative w-full flex justify-center items-center px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition-all duration-200"
                    >
                      <img
